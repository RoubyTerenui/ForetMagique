...
public class ListOfRules {
	...
	public ListOfRules(){
		...
		// If light then enter
		// Si il y a de la lumi�re sur la case au d�part, alors on sort de la for�t
		
		List<Object[]> conditionRule1 = new ArrayList<Object[]>();
		Object[] cd1_1 = {5, true, false}; //{6�me fact, doit �tre true, appliqu� sur la case}
		...
		Object[] cd8_1 = {3, true, false}; //{4�me fact, doit �tre true, appliqu� sur la case}
		conditionRule8.add(cd8_1);
						
		List<Object[]> conclusionRule8 = new ArrayList<Object[]>();
		Object[] cc8_1 = {"", 6, true, true}; //{pas d'action, 7�me fact, passe true, appliqu� sur les cases ajd}
		...
		// Si une case avec un monstre a d�j� �t� visit�e, c'est qu'il n'y a pas de monstre
		
		List<Object[]> conditionRule9 = new ArrayList<Object[]>();
		Object[] cd9_1 = {1, true, false}; //{2�me fact, doit �tre true, appliqu� sur la case}
		Object[] cd9_2 = {6, true, false}; //{7�me fact, doit �tre true, appliqu� sur la case}
		conditionRule9.add(cd9_1);
		conditionRule9.add(cd9_2);
						
		List<Object[]> conclusionRule9 = new ArrayList<Object[]>();
		Object[] cc9_1 = {"", 6, false, false}; //{pas d'action, 7�me fact, passe false, appliqu� sur la case}
		...
		Object[] cd10_1 = {4, true, false}; //{5�me fact, doit �tre true, appliqu� sur la case}
		conditionRule10.add(cd10_1);
						
		List<Object[]> conclusionRule10 = new ArrayList<Object[]>();
		Object[] cc10_1 = {"", 7, true, true}; //{pas d'action, 8�me fact, passe true, appliqu� sur les cases ajd}
		...
		// Si il y a un gouffre dans une case non mortelle d�j� visit�e, c'est qu'il n'y a pas de gouffre
		
		List<Object[]> conditionRule11 = new ArrayList<Object[]>();
		Object[] cd11_1 = {1, true, false }; // {2�me fact, doit �tre true, appliqu� sur la case}
		Object[] cd11_2 = {7, true, false }; // {8�me fact, doit �tre true, appliqu� sur la case}
		Object[] cd11_3 = {9, false, false }; // {10�me fact, doit �tre false, appliqu� sur la case}
		...
		Object[] cc11_1 = { "", 6, false, false }; // {pas d'action, 7�me fact, passe false, appliqu� sur la case}
		...
		Object[] cd12_1 = {3, false, false}; //{4�me fact, doit �tre false, appliqu� sur la case}
		conditionRule12.add(cd12_1);
				
		List<Object[]> conclusionRule12 = new ArrayList<Object[]>();
		Object[] cc12_1 = {"", 6, false, true}; //{pas d'action, 7�me fact, passe false, appliqu� sur les cases ajd}
		...
		Object[] cd13_1 = {4, false, false}; //{5�me fact, doit �tre false, appliqu� sur la case}
		conditionRule13.add(cd13_1);
				
		List<Object[]> conclusionRule13 = new ArrayList<Object[]>();
		Object[] cc13_1 = {"", 7, false, true}; //{pas d'action, 8�me fact, passe false, appliqu� sur les cases ajd}
		...
		// Si il n'y a ni monstre ni gouffre dans une case, on la consid�re sans risque
		
		List<Object[]> conditionRule2 = new ArrayList<Object[]>();
		Object[] cd2_1 = {6, false, false}; //{7�me fact, doit �tre false, appliqu� sur la case}
		Object[] cd2_2 = {7, false, false}; //{8�me fact, doit �tre false, appliqu� sur la case}
		conditionRule2.add(cd2_1);
		conditionRule2.add(cd2_2);
		
		List<Object[]> conclusionRule2 = new ArrayList<Object[]>();
		Object[] cc2_1 = {"", 0, true, false}; //{pas d'action, 1er fact, passe true, appliqu� sur la case}
		...
		// Si il n'y a ni caca ni vent dans une case, alors les cases autour sont consid�r�es sans risque
		
		List<Object[]> conditionRule7 = new ArrayList<Object[]>();
		Object[] cd7_1 = {3, false, false}; //{4�me fact, doit �tre false, appliqu� sur la case}
		Object[] cd7_2 = {4, false, false}; //{5�me fact, doit �tre false, appliqu� sur la case}
		conditionRule7.add(cd7_1);
		conditionRule7.add(cd7_2);
						
		List<Object[]> conclusionRule7 = new ArrayList<Object[]>();
		Object[] cc7_1 = {"", 0, true, true}; //{pas d'action, 1er fact, passe true, appliqu� sur les cases ajd}
		...
		// Si une case a d�j� �t� visit�e et qu'on y a trouv� un gouffre, alors elle est mortelle
		
		List<Object[]> conditionRule3 = new ArrayList<Object[]>();
		Object[] cd3_1 = {1, true, false}; //{2�me fact, doit �tre true, appliqu� sur la case}
		Object[] cd3_2 = {7, true, false}; //{8�me fact, doit �tre true, appliqu� sur la case}
		conditionRule3.add(cd3_1);
		conditionRule3.add(cd3_2);
						
		List<Object[]> conclusionRule3 = new ArrayList<Object[]>();
		Object[] cc3_1 = {"", 9, true, false}; //{pas d'action, 10�me fact, passe true, appliqu� sur la case }
		...
		Object[] cd4_1 = {7, true, true}; //{8�me fact, doit �tre true, appliqu� sur les cases adj}
		conditionRule4.add(cd4_1);
				
		List<Object[]> conclusionRule4 = new ArrayList<Object[]>();
		Object[] cc4_1 = {"", 2, false, true}; //{pas d'action, 3�me fact, passe false, appliqu� sur les cases ajd}
		...
		// Si une case a d�j� �t� visit�e et n'est pas mortelle alors les cases autour sont visitables
		
		List<Object[]> conditionRule5 = new ArrayList<Object[]>();
		Object[] cd5_1 = {1, true, false}; //{2�me fact, doit �tre true, appliqu� sur la case}
		Object[] cd5_2 = {9, false, false}; //{10�me fact, doit �tre false, appliqu� sur la case}
		conditionRule5.add(cd5_1);
		conditionRule5.add(cd5_2);
				
		List<Object[]> conclusionRule5 = new ArrayList<Object[]>();
		Object[] cc5_1 = {"", 2, true, true}; //{pas d'action, 3�me fact, passe true, appliqu� sur les cases ajd}
		...
		// Si une case est visitable mais qu'elle a d�j� �t� visit�e, elle n'est plus visitable
		
		List<Object[]> conditionRule6 = new ArrayList<Object[]>();
		Object[] cd6_1 = {1, true, false}; //{2�me fact, doit �tre true, appliqu� sur la case}
		Object[] cd6_2 = {2, true, false}; //{3�me fact, doit �tre true, appliqu� sur la case}
		conditionRule6.add(cd6_1);
		conditionRule6.add(cd6_2);
						
		List<Object[]> conclusionRule6 = new ArrayList<Object[]>();
		Object[] cc6_1 = {"", 2, false, false}; //{pas d'action, 3�me fact, passe false, appliqu� sur la case}
